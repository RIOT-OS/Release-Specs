...
def test_task05(riot_ctrl, mqtt_descriptor, app_id, dev_id, deveui,
                appeui, appkey):
    node = riot_ctrl(0, APP, Shell)

    client = mqtt_descriptor.client
    userdata = mqtt_descriptor.userdata
...
@pytest.mark.parametrize('nodes,dev_id',
                         ...
                         indirect=['nodes', 'dev_id'])
def test_task06(riot_ctrl, mqtt_descriptor, app_id, dev_id,
